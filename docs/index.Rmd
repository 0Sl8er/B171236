...
In order to look into whether the decrease in Gaviscon prescription is affected by socialising and celebrations in December and then the calming down and health kick during January, the levels of all prescriptions combined will be assessed for a difference. 
```{r total-trend}
...
hb_gav_plot <- gaviscon_and_education %>% 
  ...
  labs(title = "Investigating a correlation between education levels and the change is Gaviscon prescribed", 
       y = "Average difference in prescription",
